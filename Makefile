#############################################################################
# Makefile for building: FindDialog
# Generated by qmake (2.01a) (Qt 4.6.2) on: Thu Oct 23 12:09:49 2014
# Project:  FindDialog.pro
# Template: app
# Command: /usr/lib64/qt4/bin/qmake -unix -o Makefile FindDialog.pro
#############################################################################
...
Makefile: FindDialog.pro  /usr/lib64/qt4/mkspecs/linux-g++-64/qmake.conf /usr/lib64/qt4/mkspecs/common/g++-multilib.conf \
		/usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/qconfig.pri \
		/usr/lib64/qt4/mkspecs/features/qt_functions.prf \
		...
		/usr/lib64/qt4/mkspecs/features/lex.prf \
		/usr/lib64/qt4/mkspecs/features/include_source_dir.prf
	$(QMAKE) -unix -o Makefile FindDialog.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/FindDialog1.0.0 || $(MKDIR) .tmp/FindDialog1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/FindDialog1.0.0/ && $(COPY_FILE) --parents FindDialog.h .tmp/FindDialog1.0.0/ && $(COPY_FILE) --parents FindDialog.cpp main.cpp .tmp/FindDialog1.0.0/ && (cd `dirname .tmp/FindDialog1.0.0` && $(TAR) FindDialog1.0.0.tar FindDialog1.0.0 && $(COMPRESS) FindDialog1.0.0.tar) && $(MOVE) `dirname .tmp/FindDialog1.0.0`/FindDialog1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/FindDialog1.0.0
...
compiler_moc_header_make_all: moc_FindDialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_FindDialog.cpp
moc_FindDialog.cpp: FindDialog.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) FindDialog.h -o moc_FindDialog.cpp
